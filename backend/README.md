...
## Project Structure
    ...
    ├── santosh_module_inst_90079  # Django project configurations
...
1. Clone this repo and `cd santosh_module_inst_90079`
...
2. Clone this repo and `cd santosh_module_inst_90079`
